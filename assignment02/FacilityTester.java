...
public class FacilityTester {
	...
	@Test
	public void testFaciltySetPhyscian() {
		verySmallFacility.setPhysician(uHID3, 3232323);
		assertEquals(3232323, verySmallFacility.lookupByUHID(uHID3).getPhysician());
	}
	
	@Test
	public void testFaciltyAddPatientFalse() {
		assertFalse(verySmallFacility.addPatient(new CurrentPatient("Riley", "Nguyen", uHID3, 9879876, date3)));
	}
	
	@Test
	public void testFaciltySetLastVisit() {
		verySmallFacility.setLastVisit(uHID1, date3);
		assertEquals(date3, verySmallFacility.lookupByUHID(uHID1).getLastVisit());
	}
	...
	public void testGetFirstName() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		assertEquals("Taylor", expectedPatient2.getFirstName());
	}
	
	@Test
	public void testGetLastName() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		assertEquals("Miller", expectedPatient2.getLastName());
	}
	
	@Test
	public void testEqualsTrue() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		Patient expectedPatient1 = expectedPatient2;
		assertTrue(expectedPatient2.equals(expectedPatient1));
	}
	...
	public void testEqualsFalse() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		Patient expectedPatient1 = expectedPatient2;
		assertFalse(expectedPatient2.equals(new Object()));
	}
	
	@Test
	public void testToString() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		assertEquals("Taylor Miller (UVWX-7890)",expectedPatient2.toString());
	}
	
	@Test
	public void testUpdateLastVisit() {
		CurrentPatient expectedPatient2 = new CurrentPatient("Taylor", "Miller", new UHealthID("UVWX-7890"),1010101, date1);
		expectedPatient2.updateLastVisit(date2);
		assertEquals(date2, expectedPatient2.getLastVisit());
	}
	
	@Test
	public void testUIDTooShort() {
		//ensures an exception isnt thrown.
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("4040"));
	}
	
	@Test
	public void testUIDTooShort2() {
		//ensures an exception isnt thrown.
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("4VWX-4040"));
	}
	
	@Test
	public void testUIDTooShort3() {
		//ensures an exception isnt thrown.
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("HVWX-4J40"));
	}
	
	@Test
	public void testEqualsFalseUID() {
		Patient expectedPatient2 = new Patient("Taylor", "Miller", new UHealthID("UVWX-7890"));
		assertFalse(expectedPatient2.getUHealthID().equals(new Object()));
	}
