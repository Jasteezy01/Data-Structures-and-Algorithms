...
public class FacilityGenericTester {
	...
	@Test
	public void testFaciltyGenericSetPhyscian() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", p3id1, 7, p3date1));
		facilty1.setPhysician(p3id1, 4);
		assertEquals((Integer) 4, (Integer) facilty1.lookupByUHID(p3id1).getPhysician());
	}
	
	@Test
	public void testFaciltyGenericSetDate() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", p3id1, 7, p3date1));
		facilty1.setLastVisit(p3id1, p3date2);
		assertEquals(p3date2, facilty1.lookupByUHID(p3id1).getLastVisit());
	}
	
	@Test
	public void testFaciltyGenericSortFirstName() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id1, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("B", "A", p3id3, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("C", "A", p3id2, 7, p3date1));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByName();
		assertEquals(orderedList.get(0), new CurrentPatientGeneric<Integer>("A", "A", p3id1, 7, p3date1));
	}
	
	@Test
	public void testFaciltyGenericSortLastName() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", p3id1, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "C", p3id3, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date1));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByName();
		assertEquals(orderedList.get(0), new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date1));
	}
	
	@Test
	public void testFaciltyGenericSortUHID() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", new UHealthID("ASSD-4373"), 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id3, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date1));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByName();
		assertEquals(orderedList.get(0), new CurrentPatientGeneric<Integer>("A", "A", new UHealthID("ASSD-4373"), 7, p3date1));
	}
	
	@Test
	public void testFaciltyGenericSortDate() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", p3id1, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id3, 7, p3date2));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date3));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByDate(p3date3);
		assertEquals(2, orderedList.size());
	}
	
	@Test
	public void testFaciltyGenericSortDate2() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", p3id1, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id3, 7, p3date2));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date3));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByDate(p3date3);
		assertEquals(p3date2, orderedList.get(0).getLastVisit());
	}
	
	@Test
	public void testFaciltyGenericSortDateUHID() {
		FacilityGeneric<Integer> facilty1 = new FacilityGeneric<Integer>();
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "B", new UHealthID("ASSD-4373"), 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id3, 7, p3date1));
		facilty1.addPatient(new CurrentPatientGeneric<Integer>("A", "A", p3id2, 7, p3date1));
		ArrayList<CurrentPatientGeneric<Integer>> orderedList = facilty1.getOrderedByDate(p3date3);
		assertEquals(orderedList.get(0), new CurrentPatientGeneric<Integer>("A", "A", new UHealthID("ASSD-4373"), 7, p3date1));
