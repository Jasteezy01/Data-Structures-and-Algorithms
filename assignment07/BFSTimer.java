    ...
    public static void main(String args[]) {
        ...
        for (int n = 500; n <= 20_000; n += 500) {
            ...
            for (int i = 0; i < timesToLoop; i++) {
                GraphUtility.shortestPath(sources, destinations, sources.get((int) Math.random()*sources.size()), destinations.get((int) Math.random()*destinations.size()));
            }
            ...
            System.out.println("Breadth First Search: " + n + "\t" + averageTime + "\t");
