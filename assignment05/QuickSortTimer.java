...
// Average it over the number of runs
            ...
            System.out.println(n + "\t" + "O(1) " +averageTime/1 + "\t" +  "O(N) " + averageTime/(n) + "\tO(NlgN) " +averageTime/(n * Math.log(n)) + "\t" + "O(lgN) " +averageTime/Math.log(n) + "\t" + "O(N^2) " +averageTime/(n*n));
