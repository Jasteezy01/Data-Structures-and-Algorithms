...
public class SortedVsRandomTimer {
    public static void main(String args[]) {
        ...
        for (int n = 500; n <= 10_000; n += 500) {
            ...
            sortedBST.addAll(sortedList);
            randomBST.addAll(randomList);
            ...
            System.out.print("Sorted BST: " + n + "\t" + averageTime + "\t");
         ...
         // Now, run the test for the sorted BST
            ...
            System.out.println("Random BST: " + n + "\t" + averageTime2 + "\t");
