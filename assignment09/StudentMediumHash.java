...
public class StudentMediumHash {
	...
	/**
	 * @return true if this student and 'other' have the same UID, first name,
	 * and last name; false otherwise
	 */
	public boolean equals(Object other) {
		...
		return this.uid == rhs.uid && this.firstName.equals(rhs.firstName) &&
